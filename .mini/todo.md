...
- [ ] Rozšířit AI analýzu o logiku a obecný kód (ne jen non-goaly): logické chyby, divné/riskantní vzorce. Navazuje na fázi 43 (ta dělá jen non-goaly). Každý nález míří na konkrétní místo v kódu.
